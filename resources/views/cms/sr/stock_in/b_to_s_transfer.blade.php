...
<div class="content">
    <div class="block block-rounded">
        <div class="block-content">
            <form action="{{route('b.to.sr.transfer.confirm')}}" method="post" id="form_1">
            @csrf
...
function branch_and_sr_select_next_step() {
    ...
    if(sender_branch != 0 && sr != 0) {
        ...
        var title = sender_branch_name+" To <sapn class='text-info'>"+receiver_sr_name+"</sapn> Transfer Product";
