        ...
        <h3>Update Branch Info.</h3>
            ...
            <div class="block block-rounded d-flex flex-column">
                <div
                    ...
                    <form action="{{url('/admin/update-branch/'.$branch_info->id)}}" method="post" id="form_1">
                    @csrf
                    <div class="block-content font-size-sm row">
                        <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input">Branch Name</label>
                                    <input type="text" value="{{optional($branch_info)->branch_name}}" class="form-control" required name="branch_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input">Branch Address</label>
                                    <input type="text" value="{{optional($branch_info)->branch_address}}" class="form-control" required name="branch_address">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input">Primary Phone Number</label>
                                    <input type="text"  value="{{optional($branch_info)->branch_phone_1}}" class="form-control" required name="branch_phone_1">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input">Optional Phone Number</label>
                                    <input type="text"  value="{{optional($branch_info)->branch_phone_2}}" class="form-control" name="branch_phone_2">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="example-text-input">Email</label>
                                    <input type="email"  value="{{optional($branch_info)->branch_email}}" class="form-control" id="" name="branch_email">
                                </div>
                            </div>
