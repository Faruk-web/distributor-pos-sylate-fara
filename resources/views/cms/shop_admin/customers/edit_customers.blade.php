...
<div class="content">
    <div class="block block-rounded">
        <div class="block block-rounded block-themed block-transparent mb-0">
            <form action="{{url('/admin/update-customer/'.$customer->id)}}" method="post" id="form_1">
                @csrf
                    ...
                    <div class="col-md-4 d-none">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="branch_id">
                                ...
                                <option @if($branch->id == $customer->branch_id) selected class="bg-success" @endif value="{{$branch->id}}">{{$branch->branch_name}}[{{$branch->branch_address}}]</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
