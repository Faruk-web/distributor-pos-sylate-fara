...
class CreateSrToBranchTransferProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sr_to_branch_transfer_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sr_to_branch_transfer_products');
    }
}
