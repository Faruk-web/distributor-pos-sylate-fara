...
class CreateBranchToSRTransferProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('branch_to_s_r_transfer_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('branch_to_s_r_transfer_products');
    }
}
